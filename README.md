# Claude AI中文站：Claude 3.7 Sonnet 免费使用教程与镜像网站推荐 【5月最新更新】

> 国内可访问的 Claude AI 中文版的指南，支持 Claude 3.7 Sonnet，无需翻墙   
> 更新时间: 2025/05/30 
...
|------------|------|----------|-----------|-----------|
| Claude AI中文站 | [chat.lanjing.pro](https://chat.lanjing.pro) | Claude 3.5 Sonnet, Thinking | 有免费额度 | 支持Claude全系列模型，支持4o画图 |
...
1. **访问镜像站点:** 选择推荐的镜像站（如 [Claude 中文站](https://chat.lanjing.pro)）
2. **注册或直接使用:**
   - 注册：填写邮箱或手机号，完成注册
   - 免注册：部分站点允许直接使用
